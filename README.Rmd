...
Call `modislst` and prepare the necessary data. This example will show you how to fill Aqua LST scene for Antarctica. 
...
Aspect and Digital Elevation Model of Antarctica obtained from National Snow & Ice Center (https://nsidc.org/data/nsidc-0082/versions/2)], used as covariables after matching their extent and origin with Aqua/Terra scenes. 
